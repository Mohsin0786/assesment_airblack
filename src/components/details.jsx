...
<div className={styles.vectorParent}>
      ...
      <div className={styles.frameParent}>
        <div className={styles.frameGroup}>
          <img className={styles.frameChild} alt="" src="../../public/Frame 12705.svg" />
          <div className={styles.doItTogetherLiveOn}>
            Do-it-together, live on zoom
          </div>
        </div>
        <div className={styles.frameGroup}>
          <img className={styles.frameItem} alt="" src="../../public/Frame 12706.svg" />
          <div className={styles.doItTogetherLiveOn}>
        ...
        <div className={styles.frameGroup}>
          <img className={styles.frameItem} alt="" src="../../public/Frame 12707.svg" />
          <div className={styles.doItTogetherLiveOn}>
